...
if(isset($_FILES['upl']) && $_FILES['upl']['error'] == 0){
	...
	if(!$tem_name){
		...
		$my_insert_query = "INSERT INTO `templates_upload` (`id`, `file_name`, `file_type`, `file_size`, `file_path`, `date`) VALUES (NULL, '$file_name', '$file_type', '$file_size', '$file_path', CURRENT_TIMESTAMP)";
